...
public class ProductoController {
    ...
    @Operation(summary = "Crear nuevo producto", description = "Crea un nuevo producto en el sistema (asíncrono)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "202", description = "Solicitud de creación aceptada y procesándose"),
    ...
    @Operation(summary = "Actualizar producto", description = "Actualiza un producto existente (asíncrono)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "202", description = "Solicitud de actualización aceptada y procesándose"),
            @ApiResponse(responseCode = "400", description = "Datos inválidos"),
            @ApiResponse(responseCode = "404", description = "Producto no encontrado")
    })
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Eliminar producto", description = "Elimina un producto del sistema (asíncrono)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "202", description = "Solicitud de eliminación aceptada y procesándose"),
            @ApiResponse(responseCode = "404", description = "Producto no encontrado")
    })
    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.ACCEPTED)
    ...
    @Operation(summary = "Actualizar stock", description = "Incrementa o decrementa el stock de un producto (asíncrono)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "202", description = "Solicitud de actualización de stock aceptada y procesándose"),
