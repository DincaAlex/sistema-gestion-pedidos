...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient oauthClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://localhost:8085/login/oauth2/code/oauth-client")
                .redirectUri("http://localhost:8085/authorized")
                .redirectUri("http://127.0.0.1:8085/login/oauth2/code/oauth-client")
                .redirectUri("http://127.0.0.1:8085/authorized")
                .redirectUri("https://oauth.pstmn.io/v1/callback")
                .postLogoutRedirectUri("http://localhost:8085/logout")
    ...
    public AuthorizationServerSettings authorizationServerSettings() {
        String issuer = System.getenv().getOrDefault("OAUTH_ISSUER", "http://localhost:8080");
